(function () {
  ...
  const STYLE_PRESETS = {
    ko: [
      ...
      { name: "따뜻한 민담 2D 애니", desc: "둥근 얼굴·큰 눈·파스텔 한복·수채 마을 배경", preview: "assets/style-ko-clean-cel.png?v=reference-2d-anime-20260803", tail: "warm cheerful Korean folktale 2D animation, cute rounded faces with large sparkling eyes, tiny nose and mouth, slim graceful figures, fine warm-brown outlines, bright pastel hanbok with delicate traditional patterns, light soft cel shading, watercolor-like sunny Joseon village backgrounds, cream peach mint sky-blue palette, wholesome storybook mood, no dark dramatic shadows" },
